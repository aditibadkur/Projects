...
background = cv.imread('New folder\Background.png')
# background = cv.resize(background, (1280),(720))

ball = cv.imread('New folder\Ball.png',cv.IMREAD_UNCHANGED)
bat1 = cv.imread('New folder\Bat1.png',cv.IMREAD_UNCHANGED)
bat2 = cv.imread('New folder\Bat2.png',cv.IMREAD_UNCHANGED)
gameOver = cv.imread('New folder\GameOver.png')
